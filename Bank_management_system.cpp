...
openAccount(Account user)
{
 ...
 ofstream outfile("E:/Account.txt", ios::app);
 if(!outfile)
 {
...
ifstream infile("E:/Account.txt");
ofstream outfile("E:/Account Temp.txt");
if(!infile || !outfile){
cout<<"\tError: File Can't Open!"<<endl;
}
...
if(id == userID)
{
 ...
 outfile.close();
 infile.close();
 remove("E:/Account.txt");
 rename("E:/Account Temp.txt", "E:/Account.txt");
 Sleep(5000);
}
...
else
{
 ...
 infile.close();
 remove("E:/Account.txt");
 rename("E:/Account Temp.txt", "D:/Account.txt");
 Sleep(5000);
}
